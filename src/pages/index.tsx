  ...
  return (
    <div className="h-screen bg-white ">
      <div className="flex  w-full items-center justify-between p-4">
        <h1 className="uppercase ">Todo App</h1>
        <div className="flex items-center  space-x-4 ">
          <h1 className="">Bryan Gasper</h1>
          <div className="h-12 w-12 rounded-full  bg-red-700"></div>
        </div>
      </div>
      <div className="flex  items-center justify-center space-x-4 py-4">
        <input
          className="rounded-md h-12 w-1/2 border border-gray-500 bg-transparent px-2  focus:outline-none focus:ring-gray-200 "
          placeholder="Search"
        />
        <button
          type="button"
      ...
      <div className="flex h-screen flex-col items-center space-y-4 px-4">
        ...
        <div className="w-full md:w-1/2 rounded-md border border-gray-600  px-4 py-6   hover:shadow-xl">
          <h1>Title</h1>
